...
class XianNextlocLLMDatasetMer(AbstractDataset):
    ...
    def get_data(self):
        ...
        self.loc_x_mean=12127688.911672873
        self.loc_y_mean=4061502.8191582197

        self.loc_x_std=2413.5536210459386
        self.loc_y_std=2560.3461843579544
        self.duration_max=59.5
        self.duration_min=0.3333333333333333
